		...
		<?php
            ...
            if ($userIsLoggedIn && $currentPage !== '/logout') {
                ...
                <nav class="flex items-center" id="navbar">
					...
					<?php
							?> 
								<a href="<?= site_url('AjoutExam') ?>" class="ml-4 page-link">Ajout d'examen</a>
							<?php
					?>
                    <a href="<?= site_url('rattrapages') ?>" class="ml-4">Rattrapages</a>
                    <a href="<?= site_url('UserProfile') ?>" class="ml-4">Mon profil</a>
                    <a href="<?= site_url('logout') ?>" id="logoutBtn" class="ml-4 page-link">

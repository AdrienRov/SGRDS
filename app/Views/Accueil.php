...
<main class="flex-1">
	<div class="w-1/2 mx-auto">
		<?php if ($user->type == 1) : ?>
			<div class="border border-gray-400 rounded-lg p-4 flex flex-col gap-3 my-4">
		...
		<div class="border border-gray-400 rounded-lg p-4 flex flex-col gap-1 my-4">
			<h1 class="text-2xl font-bold">Examens</h1>
			<div>
				<a href="<?= site_url('AjoutExam') ?>" class="px-8  py-1 text-white bg-orange hover:bg-orange-light font-bold">Ajouter un examen</a>
				<input type="text" name="search" id="search" placeholder="Rechercher" class="px-16 py-1 border border-slate-300" />
				<select name="semester" id="semester" class="px-32 py-1 my-4">
				...
				<label for="mine">Mes examens</label>
